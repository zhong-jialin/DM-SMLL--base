...
<body>
    ...
    <div class="container shanpinpic">
        ...
        <h4 class="mt-4"><a href="index.php">首页</a>>搜索><?php echo $get?></h4>
					...
					<div class="row  ">
						<?php
						    include_once 'dbsql.php';
                                                    ...
                                                    $get=$_POST['search'];
                                                    $db=new DbMysql();
                                                    $result=$db->select("select * from product where title like '%$get%'");
                                                    ...
                                                    $sql="select * from product where title like '%$get%'";
                                                    $sql.=$page->limit();
