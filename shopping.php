...
<body>
	...
	<div class="xiangqing">
		<div class="neirong w">
                        ...
                        ?>
        <form method="post" action="gowuche.php">
        	<div id="row">
        		
        	
			<div class="jieshao mt20 w">
            <div class="left fl col-4"><img src="<?php echo $picurl;?>" width="220px"></div>
			<div class="right fr">
				<div class="col-8">
					
			<div class="h3 ml20 mt20"><?php echo $title;?></div>
			<div class="jianjie mr40 ml20 mt10"><?php echo $content;?></div>
			<div class="jiage ml20 mt10">价格：<?php echo $price;?>元</div>
			...
			<div class="xqxq mt20 ml20">
				<div class="top1 mt10">
					<div class="left1 fl"><?php echo $title;?> <?php echo $content;?></div>
					<div class="right1 fr"><?php echo $price;?>元</div>
					<div class="clear"></div>
				</div>
				<div class="bot mt20 ft20 ftbc">总计：<?php echo $price;?></div>
			</div>
			</div>
