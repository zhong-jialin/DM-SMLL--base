...
<body>
    ...
    <!-----------------常见问题begin ----------------------->
    <div class="container shanpinpic mt-5">
        <div class="gwcxqbj ">
			<div class="gwcxd center ">
				...
				<div class="content2 center ">
					...
					<div class="sub_content fl"><img src="<?php echo $row['picurl']?>"></div>
					<div class="sub_content fl ft20"><?php echo $row['title']?> <?php echo $row['content']?></div>
					<div class="sub_content fl "><?php echo $row['price']?></div>
					<div class="sub_content fl">
