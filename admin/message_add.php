...
<html>
	...
	<body>
		<div class="admin-content-body">
          ...
          <tr>
            <td>
            <form method="post" action="message_addsave.php">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">			
              <tr>
                <td width="20%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">管理员账号：</td>
                <td width="3%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2"><input name="usernameadd" type="text" id="username" size="30" /></td>
              </tr>
              <tr>
                <td height="30" align="right" class="left_txt2">管理员密码：</td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="passwordadd" size="30" id="password" /></td>
              </tr>
              <tr>
                <td height="30" align="right" class="left_txt2">管理员电话：</td>
                <td>&nbsp;</td>
                <td height="30"><input type="text" name="email" size="30" id="password" /></td>
              </tr>
              <tr>
