         ...
         <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td>
                                ...
                                $id=$_GET['id'];
                                $db = new DbMysql();
                                $result=$db->select("select * from product where id=$id",1);
                        ...
                        ?>
                <form method="post" action="product_upd_save.php?id=<?php echo $id?>" enctype="multipart/form-data">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="10%" height="30" align="right" bgcolor="#f2f2f2" class="left_txt2">商品编号：</td>
                <td width="1%" bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2"><input name="numbers" type="text" id="numbers" size="30" value="<?php echo $numbers;?>" /></td>
              ...
              <tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2"><label for="typeid"></label>
                  ...
                  <?php
                   require_once 'dbsql.php';
                   $add=new DbMysql();
                   $result=$add->select("select * from productype");
                   foreach ($result as $row)
                      {
                   ?>
                      <option value="<?php echo $row['id']?>" <?php if($typeid==$row['id']) echo "selected";?>>
               ...
               <tr>
                ...
                <td bgcolor="#f2f2f2">&nbsp;</td>
                <td width="32%" height="30" bgcolor="#f2f2f2"><input name="price" type="text" id="price" size="30" value="<?php echo $price;?>"/></td>
              ...
              <tr>
                ...
                <td width="32%" height="30" bgcolor="#f2f2f2" class="left_txt">
                    <input type="file" name="upfile"   id="upfile"  size="30" value="<?php echo $picurl;?>">
                </td>
              ...
              <tr>
                ...
                <td height="30" colspan="2" bgcolor="#f2f2f2"> 
                    <textarea name="content" id="content" cols="45" rows="5" class="ckeditor">
                        <?php echo $content;?>
                    </textarea></td>
                </tr>
              <tr>
