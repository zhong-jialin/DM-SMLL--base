					...
					<div class="am-btn-toolbar">
						<div class="am-btn-group am-btn-group-xs">
							<button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span>
                                                        <a href='newsType_add.php'><i class="fa fa-hand-spock-o"></i>添加产品分类</a></button>
						</div>
					</div>
				</div>
						...
						<table class="am-table am-table-striped am-table-hover table-main">
							<thead>
								<tr>
									...
									<th class="table-title">类型号</th>
									<th class="table-type">商品名称</th>
									<th class="table-author am-hide-sm-only">SD</th>
