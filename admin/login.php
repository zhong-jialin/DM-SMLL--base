	...
	<body>
		...
		<div class="top center">
			<div class="logo center">
				<a href="./index.html" target="_blank"><img src="../image/mistore_logo2.png" alt=""></a>
			</div>
		</div>
		...
		<div class="login">
			<div class="login_center">
				<div class="login_top">
					...
					<div class="right fr">您还不是我们的管理？<a href="adduser.php" target="_self">点击注册！</a></div>
					<div class="clear"></div>
		...
		<footer>
			...
			<div class="copyright">大米公司版权所有-京ICP备10046444-<img src="../image/ghs.png" alt="">京公网安备11010802020134号-京ICP证110507号</div>
