	...
	<body>
		<div class="dvheader">
			<div class="dvheadertools">
				<span class="headerspantitle">大米网站后台</span>
				<ul class="headerultools">
					...
					<li class="headerlitools_info headerlitools" style="background-color: #74abda">
						...
						网站后台<i style="margin-left: 8px;" class="icon-caret-down"></i>
		...
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<a href="product.php" target="right">
							<li>产品</li>
						</a>
						<a href="news.html" target="right">
							<li>新闻</li>
						</a>
                                            	<a href="news.php" target="right">
							<li>新闻分类</li>
						</a>
						<a href="newsType.php" target="right">
							<li>产品分类</li>
						</a>
						<a href="user.php" target="right">
							<li>普通用户</li>
						</a>
						<a href="message.php" target="right">
							<li>管理员</li>
						</a>
					</ul>
				</li>
			...
			<div style="position: absolute; left: 191px; right: 20px; ">
				<iframe src="product.php" scrolling="no"  width="100%" height="1200" name="right" border="none"></iframe>
			</div>
		</div>
